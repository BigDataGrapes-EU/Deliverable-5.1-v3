...
class Piechart extends React.Component {
  ...
  showGraph() {
    ...
    const data = {labels: ['Fruity', 'Acid', 'Candy'], datasets: [{data: [300, 50, 100], backgroundColor: ['#FF6384','#36A2EB','#FFCE56'],hoverBackgroundColor: ['#FF6384','#36A2EB','#FFCE56']}]};
    //const data = {labels: labels, datasets: [{backgroundColor: this.state.colorPickerButtonAgg , data: dataset, }]}
    if(!this.state.editMode) return <Pie data={data}/>
  }
